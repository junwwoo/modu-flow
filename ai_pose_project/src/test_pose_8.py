...
TRUNK_LEAN_RATIO     = 1.5   # 14주차: 0.8→1.5 (m1·m2·m3 데이터: 정상 깊은 스쿼트 lean 0.65~1.25 가
                             # 자연스러움 → 의도적 숙임 1.9+ 만 검출. 다수가 1.0+ 라 0.8 은 m1 과적합이었음)
...
LUNGE_TRUNK_LEAN_RATIO    = 1.1   # 14주차: 0.5→1.1 (m1·m2 데이터: 정상 런지 lean 0.27~0.85 / 의도적 숙임 1.4~2.0)
